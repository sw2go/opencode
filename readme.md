...
- Continue Session
    ...
    ```
    Old sessions id's you find in ./share/log/opencode.log. It is written to the local share folder that is mounted by docker, to persist opencode data outside the docker container. 
